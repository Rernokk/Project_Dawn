...
#pragma multi_compile CB_TYPE_ONE CB_TYPE_TWO CB_TYPE_THREE CB_TYPE_FOUR NONE
#pragma target 3.0
...
#elif CB_TYPE_THREE
        tmp1 = LmsColorBlindType3(tmp2, _BlindIntensity);
#else
        tmp1 = tmp2;
#endif
