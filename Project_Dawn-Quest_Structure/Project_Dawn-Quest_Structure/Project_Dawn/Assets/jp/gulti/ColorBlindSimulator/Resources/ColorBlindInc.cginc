...
inline fixed3 Rgb1ToRgb2_Type3(fixed3 rgb1){
  return rgb1 * 0.927237 + fixed3(0.0113814, 0.0113814, 0.0113814);
}
...
inline fixed3 Rgb2ToRgb1_Type3(fixed3 rgb2)
{
  return (rgb2 - fixed3(0.0113814, 0.0113814, 0.0113814)) / 0.927237;
}
...
inline fixed3 LmsColorBlindType3(fixed3 lms_normal, fixed intensity)
{ 
  return fixed3(lms_normal.r, intensity * (lms_normal.r * 1.7 + lms_normal.b * .02) + (1 - intensity) *  lms_normal.g, intensity * (lms_normal.r * 1.7 + lms_normal.g * .02) + (1 - intensity) *  lms_normal.b);
}
